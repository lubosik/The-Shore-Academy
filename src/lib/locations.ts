...
export const locations: LocationData[] = [
  ...
  },
  {
    ...
    mapMarkers: [
      {
        ...
        description: "The closest public parking lot to the pier, directly adjacent to the pier entrance. Paid parking, $2/hr. 1-minute walk to our meeting point at the pier.",
      },
      {
        lat: 26.3192,
        lng: -80.0839,
        ...
        description: "Meet your Shore Academy instructor at the Deerfield Beach International Fishing Pier entrance. Look for the blue Shore Academy flag.",
      },
    ],
    mapWalkPath: [
      [26.3197, -80.0849],
    ...
    faqs: [
      ...
      { q: "Where do I park for Deerfield Beach sessions?", a: "Park in the pier parking lot directly adjacent to the Deerfield Beach Pier entrance. It is the closest lot to our meeting point — a 1-minute walk. Paid parking at $2/hr." },
