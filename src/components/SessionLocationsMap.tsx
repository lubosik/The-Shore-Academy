...
const LOCATIONS = {
  saturday: {
    ...
    icon: "🌊",
    accentColor: "#0fa3b1",
    center: [26.3193, -80.0844] as [number, number],
    zoom: 17,
    markers: [
      {
        lat: 26.3197,
        ...
        label: "Pier Parking Lot, Deerfield Beach",
        description:
          "The closest public parking lot to the pier, directly adjacent to the pier entrance. Paid parking, $2/hr. 1-minute walk to the meeting point.",
      },
      {
        lat: 26.3192,
        lng: -80.0839,
        ...
        description:
          "Meet your Shore Academy instructor at the Deerfield Beach International Fishing Pier entrance. Look for the blue Shore Academy flag.",
      },
    ],
    walkPath: [
      [26.3197, -80.0849],
    ...
    note: "Sessions meet at the Deerfield Beach Pier. Full details confirmed the evening before your session.",
    steps: [
      { icon: "🅿️", title: "Park up", text: "Use the pier parking lot directly next to the pier entrance. Arrive 15 minutes early." },
      { icon: "🚶", title: "Follow the path", text: "Short walk from the pier parking lot to the pier entrance — shown on the map above." },
      { icon: "📍", title: "Find our team", text: "Look for The Shore Academy instructors in coral rash guards at the pier." },
